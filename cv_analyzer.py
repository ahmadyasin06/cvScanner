...
# cv_analyzer.py ke bilkul start mein paste karein:
...
SKILL_CATEGORIES = {
    "IT / Software Development": [
        ...
        "qa testing", "manual testing", "automation testing", "selenium", "QA Testing", "manual testing", "automation testing", "selenium"
    ],
    "Data & AI": [
        "machine learning", "deep learning", "tensorflow", "pytorch", "nlp", "computer vision",
        "data analysis", "data science", "data engineering", "big data", "etl",
    ...
    "Human Resources (HR)": [
        ...
        "background verification", "hr operations", "succession planning", "exit interviews"
    ],
    "Finance & Accounting": [
...
# Dynamic categories se auto-generate hone wali master list
COMMON_SKILLS = [skill for sublist in SKILL_CATEGORIES.values() for skill in sublist]
...
def _extract_contact_info(text: str) -> dict:
  """Extracts email and phone number safely using regex."""
  ...
  # Phone number Extraction (Safer length check to avoid years like 2020-2023)
  ...
  for candidate in phone_candidates:
    ...
    # 🌟 Fix: Phone numbers are usually 10 to 13 digits long (ignoring years like 8-digit ranges)
    if 10 <= len(digits_only) <= 13:
      # Extra check to ensure it's not starting with a year pattern like 2019, 2020, etc.
