...
def page_history():
    ...
    for record in records:
        ...
        # OPTION A: If you want to use the reusable ui component from ui_components instead of raw custom HTML:
        if is_expanded:
            with st.container():
                # Reusing your ui_components function here:
                ui.render_candidate_card(record)
                
                # OR if you want to remove the expanded view completely, just delete everything inside this 'if is_expanded:' block.
